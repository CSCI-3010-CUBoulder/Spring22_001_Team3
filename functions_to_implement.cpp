...
//adding tkokes change

// Splits a single string on separator into a vector of strings
std::vector<std::string> Split( std::string whole, std::string separator );

// takes two strings and returns a new string that is the result of removing all occurrences of s2
// from s1.
std::string RemoveAllSubstrings( std::string s1, std::string s2 );

// takes two strings and returns a new string that is the result of removing the first occurrence of
// s2 from s1.
...
// takes two vectors of integers, a and b. The function then removes elements from a if they are
// also in b. If the integer is in b, but not in a, nothing happens.
...
// takes an integer n that is >= 0 and returns a vector of all squares up to n^n (1^1, 2^2, 3^3,
// .... n^n)
...
// takes two vectors of doubles, a and b. The function then removes elements from a if they are also
// in b. If the double is in b, but not in a, nothing happens.
...
// returns a vector with true for numbers greater than the second parameters and false for those
// less than or equal to
std::vector<bool> GreaterMask( std::vector<double> nums, double greater_than );

// returns a vector with true for numbers less than the second parameters and false for those
